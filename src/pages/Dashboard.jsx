...
export const Dashboard = ({ onSelectVideo }) => {
  ...
  return (
    ...
    <div className="content">
      ...
      {/* MAIN DASHBOARD GRID */}
      <div className="grid2">
        {/* LEFT COLUMN: Contains SOP Wajib and Bottom grid3 */}
        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                  ...
                  if (sub) {
                    ...
                    if (sub.certStatus === 'remedial' || isLegacyRemedial) {
                      ...
                      return rCount >= MAX_RETAKES
                        ? { label: 'Tidak Lulus', color: '#b91c1c', bg: '#fef2f2', border: '#fecaca' }
          ...
          {/* BOTTOM ROW GRID (Restructured under left column container) */}
          <div className="grid3">
            {/* LEADERBOARD WIDGET */}
            <div className="card">
              <div className="card-head">
