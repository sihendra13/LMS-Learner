...
const mockSops = [
  { id: 1, title: 'Proses Onboarding Klien Baru', dept: 'Sales', time: '8 Min', color: '#3b82f6', videoUrl: '/videos/onboarding-client.mp4' },
  { id: 2, title: 'Standar Pelayanan Kasir', dept: 'Operations', time: '12 Min', color: '#10b981', videoUrl: '/videos/cashier-service.mp4' },
  ...
  { id: 4, title: 'Protokol Kesehatan & Keselamatan Kerja', dept: 'HRD & GA', time: '10 Min', color: '#ef4444', videoUrl: '/videos/workplace-safety.mp4' },
  { id: 5, title: 'Manajemen Inventori Gudang', dept: 'Logistics', time: '15 Min', color: '#8b5cf6', videoUrl: '/videos/warehouse-inventory.mp4' },
];
